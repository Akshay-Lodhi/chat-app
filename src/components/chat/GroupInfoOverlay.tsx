    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div 
          ...
          className="absolute top-0 right-0 w-full md:w-[350px] lg:w-[400px] h-full bg-background z-[10000] flex flex-col shadow-[-10px_0_30px_rgba(0,0,0,0.1)] border-l border-surface-border"
        >
        {/* Header */}
