...
export function BottomNav({
  ...
  return (
    <div className="w-full shrink-0 z-40 px-4 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom,24px))] bg-surface/80 backdrop-blur-3xl border-t border-surface-border/30 shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
